...
function Build-CfaProcessed {
    ...
    $n=$Rows.Count;$p=$FactorIds.Count;$X=[double[,]]::new($n,$p);$yr=New-Object double[] $n;$yc=New-Object double[] $n
